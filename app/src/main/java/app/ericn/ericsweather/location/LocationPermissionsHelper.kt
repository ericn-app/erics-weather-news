...
class LocationPermissionsHelper @Inject constructor(private val context: Application) {
    ...
    fun requestLocationPermission(fragment: Fragment) {
        requestPermission(fragment, Manifest.permission.ACCESS_COARSE_LOCATION, LOCATION_PERMISSION_REQUEST_CODE)
    }

    fun requestLocationPermission(activity: Activity) {
        requestPermission(activity, Manifest.permission.ACCESS_COARSE_LOCATION, LOCATION_PERMISSION_REQUEST_CODE)
    }
